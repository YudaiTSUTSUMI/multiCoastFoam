...
btScalar btManifoldResult::calculateCombinedFriction(const btCollisionObject* body0, const btCollisionObject* body1)
{
	...
	btScalar friction0 = body0->getFriction();
    btScalar friction1 = body1->getFriction();

    switch (FrictionSetting::Mode) {
        case COMBINE_MINIMUM:
            friction = btMin(friction0, friction1);
        case COMBINE_AVERAGE:
            friction = (friction0 + friction1) / 2.0;
