...
void btHingeConstraint::getInfo2Internal(btConstraintInfo2* info, const btTransform& transA, const btTransform& transB, const btVector3& angVelA, const btVector3& angVelB)
{
	...
	btVector3 a1 = pivotAInW - transA.getOrigin() - m_rbA.getWorldEccentricity();
	{
	...
	btVector3 a2 = pivotBInW - transB.getOrigin() - m_rbB.getWorldEccentricity();
	{
...
//	btVector3 pivotBInW = trB.getOrigin();
	...
	relB = trB.getOrigin() - bodyB_trans.getOrigin() - m_rbB.getWorldEccentricity();
	// get its projection to hinge axis
	btVector3 projB = ax1 * relB.dot(ax1);
	// get vector directed from bodyB to hinge axis (and orthogonal to it)
	btVector3 orthoB = relB - projB;
	// same for bodyA
	relA = trA.getOrigin() - bodyA_trans.getOrigin() - m_rbA.getWorldEccentricity();
